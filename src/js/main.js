...
// // Next Function to Update the channel
// function checkChannelForUpdate(channelNumber){
//   if(channelNumber === Math.floor(channelNeedlePosition/1.95)) {
//     return Math.floor(channelNeedlePosition/1.95);
//   }
//   return channelNumber;
// }

// tuningKnob.addEventListener("mousemove", () => alert('success: moving tuning knob'));
